...
unordered_map<DWORD, ProcessAndThead> IrpToProcessID;
...
VOID WINAPI ProcessEvent(PEVENT_RECORD pEvent)
{
	...
	if ((pEvent->EventHeader.EventDescriptor.Opcode == 2 && pEvent->EventHeader.ProviderId.Data1 == 0x3d6fa8d0)
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 36 && pEvent->EventHeader.ProviderId.Data1 == 1030727889)
