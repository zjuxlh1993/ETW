...
unordered_map<DWORD, string> fileNameMap;//key:fileObject,value:filename
unordered_map<int, ofstream*> OutFile_Map;//key:threadid,value:outfile*
unordered_map<int, int> messageID_Map;//key:messageid,value:pid
unordered_map<DWORD, string> KeyNameMap;//key:keyhandle,value:keyname
unordered_map<DWORD, DWORD> ThreadIDtoPID_map;//key:threadid value:processID
unordered_map<DWORD, string> ProcessName_map;//key:pid value:processname
unordered_map<DWORD, DWORD> messageID2ThreadID;//key:messageid value:threadid
unordered_map<DWORD, ProcessAndThread> IrpToProcessID;//key:irp(diskio) value:pid
...
{
	outFile.open("TraceOfETW.txt");//记录trace的文件
	whiteListPID.clear();
	...
	getallprocess();//初始化processname_map
	getallthread();//初始化threadidtopid_map

	if (ProcessNameOfRat != "CPID") ProcessIDOfRat = GetProcessID(ProcessNameOfRat); else//若非processname则读入pid
	{
		cin >> ProcessIDOfRat;
...
VOID WINAPI ProcessEvent(PEVENT_RECORD pEvent)
{
	...
	if (
		(pEvent->EventHeader.EventDescriptor.Opcode == 2 && pEvent->EventHeader.ProviderId.Data1 == 0x3d6fa8d0)//process class
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 1 && pEvent->EventHeader.ProviderId.Data1 == 0x3d6fa8d1)//thread class
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 10 && pEvent->EventHeader.ProviderId.Data1 == 0x3d6fa8d3)//PageFault_V2 class
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 0 && pEvent->EventHeader.ProviderId.Data1 == 0x90cbdc39)//fileio class
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 10 && pEvent->EventHeader.ProviderId.Data1 == 2924704302)//registry class
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 16 && pEvent->EventHeader.ProviderId.Data1 == 2586315456)//tcp class
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 14 && pEvent->EventHeader.ProviderId.Data1 == 2586315456)
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 18 && pEvent->EventHeader.ProviderId.Data1 == 2586315456)
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 27 && pEvent->EventHeader.ProviderId.Data1 == 2586315456)
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 29 && pEvent->EventHeader.ProviderId.Data1 == 2586315456)
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 30 && pEvent->EventHeader.ProviderId.Data1 == 2586315456)
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 32 && pEvent->EventHeader.ProviderId.Data1 == 2586315456)
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 34 && pEvent->EventHeader.ProviderId.Data1 == 2586315456)
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 28 && pEvent->EventHeader.ProviderId.Data1 == 2586315456)
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 31 && pEvent->EventHeader.ProviderId.Data1 == 2586315456)

		|| (pEvent->EventHeader.EventDescriptor.Opcode == 10 && pEvent->EventHeader.ProviderId.Data1 == 0xbf3a50c5)//udp class
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 11 && pEvent->EventHeader.ProviderId.Data1 == 0xbf3a50c5)
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 17 && pEvent->EventHeader.ProviderId.Data1 == 0xbf3a50c5)
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 26 && pEvent->EventHeader.ProviderId.Data1 == 0xbf3a50c5)
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 27 && pEvent->EventHeader.ProviderId.Data1 == 0xbf3a50c5)


		|| (pEvent->EventHeader.EventDescriptor.Opcode == 35 && pEvent->EventHeader.ProviderId.Data1 == 0x45d8cccd)//ALPC class
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 10 && pEvent->EventHeader.ProviderId.Data1 == 0x3d6fa8d4)//diskio class
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 67 && pEvent->EventHeader.ProviderId.Data1 == 0xce1dbfb4)// PerfInfo  class
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 10 && pEvent->EventHeader.ProviderId.Data1 == 0x2cb15d1d)//image class
		...
		|| (pEvent->EventHeader.EventDescriptor.Opcode == 32 && pEvent->EventHeader.ProviderId.Data1 == 0xd837ca92)//SplitIo class
		)
	{
...
/*		if (pEvent->EventHeader.EventDescriptor.Opcode == 1 && pEvent->EventHeader.ProviderId.Data1 == 0x3d6fa8d0){
		...
		else*/
		{
			eventcount++;
			stop = clock();
			if ((stop - start)/CLOCKS_PER_SEC>=60){//记录每60s产生的数量
				cout << eventcount / ((stop - start) / CLOCKS_PER_SEC) << " events per second" << endl;
				start = clock();
				eventcount = 0;
			}
			if (pEvent->EventHeader.EventDescriptor.Opcode == 51)//提前处理system call 加快速度
			{
			...
			if (pEvent->EventHeader.EventDescriptor.Opcode == 36 && pEvent->EventHeader.ProviderId.Data1 == 0x45d8cccd)//这个event有问题，单独处理
			{
				USES_CONVERSION;
				parm += "\"IsServerPort: ";
...
//主要思路是将event分为class进行处理，同一个class的event的参数结构是一样的，可以一并处理
//具体class分类可以看https://msdn.microsoft.com/zh-cn/library/windows/desktop/aa363784(v=vs.85).aspx
			if (ERROR_SUCCESS == status)
			{
				...
				if ((pEvent->EventHeader.EventDescriptor.Opcode == 11 || pEvent->EventHeader.EventDescriptor.Opcode == 16 || pEvent->EventHeader.EventDescriptor.Opcode == 13 || pEvent->EventHeader.EventDescriptor.Opcode == 18 || pEvent->EventHeader.EventDescriptor.Opcode == 14) && pEvent->EventHeader.ProviderId.Data1 == 0x9a280ac0){
				...
				if ((pEvent->EventHeader.EventDescriptor.Opcode == 15 || pEvent->EventHeader.EventDescriptor.Opcode == 12) && pEvent->EventHeader.ProviderId.Data1 == 0x9a280ac0){
					if (wcscmp(L"PID", (PWCHAR)((PBYTE)(pInfo)+pInfo->EventPropertyInfoArray[i].NameOffset)) == 0
						)
					{
						USES_CONVERSION;
				...
				if ((pEvent->EventHeader.EventDescriptor.Opcode == 28 || pEvent->EventHeader.EventDescriptor.Opcode == 31) && pEvent->EventHeader.ProviderId.Data1 == 0x9a280ac0){
					if (wcscmp(L"PID", (PWCHAR)((PBYTE)(pInfo)+pInfo->EventPropertyInfoArray[i].NameOffset)) == 0
						)
					{
						USES_CONVERSION;
				...
				if ((pEvent->EventHeader.EventDescriptor.Opcode == 26) && pEvent->EventHeader.ProviderId.Data1 == 0x9a280ac0){
					if (wcscmp(L"PID", (PWCHAR)((PBYTE)(pInfo)+pInfo->EventPropertyInfoArray[i].NameOffset)) == 0
						)
					{
						USES_CONVERSION;
				...
				if ((pEvent->EventHeader.EventDescriptor.Opcode == 10) && pEvent->EventHeader.ProviderId.Data1 == 0x9a280ac0){
					if (wcscmp(L"PID", (PWCHAR)((PBYTE)(pInfo)+pInfo->EventPropertyInfoArray[i].NameOffset)) == 0
						)
					{
						USES_CONVERSION;
				...
				if ((pEvent->EventHeader.EventDescriptor.Opcode == 17) && pEvent->EventHeader.ProviderId.Data1 == 0x9a280ac0){
					if (i == 0){
						threadID = pEvent->EventHeader.ThreadId;
						CPID = pEvent->EventHeader.ProcessId;
						if (CPID != ProcessIDOfRat){
				...
				if ((pEvent->EventHeader.EventDescriptor.Opcode == 17) && pEvent->EventHeader.ProviderId.Data1 == 0xbf3a50c5){
					if (i == 0){
						threadID = pEvent->EventHeader.ThreadId;
						CPID = pEvent->EventHeader.ProcessId;
						if (CPID != ProcessIDOfRat){
				...
				if ((pEvent->EventHeader.EventDescriptor.Opcode == 10 || pEvent->EventHeader.EventDescriptor.Opcode == 11) && pEvent->EventHeader.ProviderId.Data1 == 0xbf3a50c5){
					if (wcscmp(L"PID", (PWCHAR)((PBYTE)(pInfo)+pInfo->EventPropertyInfoArray[i].NameOffset)) == 0
						)
					{
						USES_CONVERSION;
				...
				if ((pEvent->EventHeader.EventDescriptor.Opcode == 26 || pEvent->EventHeader.EventDescriptor.Opcode == 27) && pEvent->EventHeader.ProviderId.Data1 == 0xbf3a50c5){
					if (wcscmp(L"PID", (PWCHAR)((PBYTE)(pInfo)+pInfo->EventPropertyInfoArray[i].NameOffset)) == 0
						)
					{
						USES_CONVERSION;
